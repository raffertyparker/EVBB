...
format(df$qHour,format='%Y%m%d %H:%M')
...
Standard charge durations of less than 8 minutes were very frequently encountered near the end of a longer charging cycle, where the state of charge had reached it's maximum. These were assumed to be minor 'top-ups', and were discarded. In addition, slow charging events greater than 100 hours were discarded, as were fast charge durations greater than 14 hours. These were presumed anomolies as they exceed the battery capacity of electric vehicles commonly encountered in New Zealand.
...
Figure \@ref(fig:durationHist) shows the overall distribution of all charging sequences. As would be expected, fast charging events tend to have a much shorted duration than standard charging.
...
Figure \@ref(fig:longDuration) shows the distribution of charging sequences. As we can see these appear to be generally less than 3 hours in length for Standard Charges.


```{r longDuration, fig.cap="Duration of charging sequences"}
