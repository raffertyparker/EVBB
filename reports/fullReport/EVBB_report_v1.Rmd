 ...
 * _Charging duration_: Charging durations tended to fall into one of two groups. Longer 'standard' charges had a median duration of `r round(medianDurationStd,2)` minutes and a mean duration of `r round(meanDurationStd,2)` minutes. High power 'Rapid' charge events had a median duration of `r round(medianDurationRapid,2)` minutes and a mean duration of `r medianDurationRapid` minutes;
