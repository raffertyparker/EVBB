 ...
 * _Charging duration_: Charging durations tended to fall into one of two groups. Longer 'standard' charges had a median duration of `r medianDurationStd` minutes and a mean duration of `r meanDurationStd` minutes. High power 'Rapid' charge events had a median duration of `r medianDurationRapid` minutes and a mean duration of `r medianDurationRapid` minutes;
