...
author: "Rafferty Parker and Ben Anderson (ben.anderson@otago.ac.nz), [Centre for Sustainability](https://www.otago.ac.nz/centre-sustainability/), University of Otago; Daniel Myall (daniel@zeno.nz, Flip The Fleet)"
...
rawDT[, hms := hms::as.hms(r_dateTime, tz = "Pacific/Auckland")] # crucial you set tz!
