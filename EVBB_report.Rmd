...
# This removes the vehicle IDs that had only zero charging
# There must be a better way of doing this but this will do for now.
df <- filter(df, id != c("4e48f4155c29c763ffe6d9e17a495200", "01583b8a5f0344cc4aa3b3939a27af2a", "0cc746a3f5ae75ee94068a8354b6be08"))
...
The data consisted of `r nrow(dt)` data points from `r  length(levels(as.factor(df$dvID)))` vehicles over 8 months (April 2018 - January 2019). The recorder provided measurements at 1 minute frequency of charging behaviour and battery charge state.

Due to the possiblilty of the identity of participants being ascertainable, the remaining data is not publically available.

## Definition, Cleaning and Preparation
